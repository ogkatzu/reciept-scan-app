...
def upload_file():
    ...
    if request.method == 'POST':
        ...
        if file.filename == '':
            return render_template('upload.html', success=False, message="Please select a file")
        ...
        if file and allowed_file(file.filename):
            ...
            if os.path.exists(file_path):
                return render_template('upload.html', success=False, message=f"Filename {filename} "
            ...
            return render_template('upload.html', success=True, file_name=f'{filename}.{extension}')
        else:
            return render_template('upload.html', success="False", message="File type not allowed")
